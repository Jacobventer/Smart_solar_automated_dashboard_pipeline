...
def plot_combined_solar(selected_date):
    ...
    #Source 1: Yesterday predicted PV
    ...
    #Source 2: Yesterday actual - inverter 
    ...
    inverter_5min = inverter_wide["pv_total_W"].resample("5min").mean() / 1000 #Average of 5 min intervals

    #Source 1: Today predicted PV 
...
def plot_daily_forecast_actual_consumption():
    factor = 0.0052 #site specific factor
