...
params = {
	"latitude": -25.7449,
	"longitude": 28.1878,
	"hourly": ["temperature_2m", "precipitation_probability", "precipitation", "weather_code", "cloud_cover", "visibility", "wind_speed_10m", "soil_temperature_0cm", "uv_index", "uv_index_clear_sky", "sunshine_duration", "direct_radiation"],
	"timezone": "auto",
